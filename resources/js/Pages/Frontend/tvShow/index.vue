...
<template>
    <Head title="Home" />
    <FrontendLayout>
   <main class="lg:w-10/12 md:w-11/12 sm:w-full mx-auto">




       <!-- TvShow Section -->
       <section class="bg-blue-50 dark:bg-gray-900 dark:text-white mt-4 p-2 rounded">
      ...
      >
       ...
       <div class=" grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 rounded">
        <Card v-for="tv in tvShows.data" :key="tv.id">
            <template #image>
              <Link :href="`/series/${tv.slug}`">
                <div class="aspect-w-2 aspect-h-3">

                  <img v-if="tv.poster_path"
                    class="object-cover"
                ...
                >
               <div>
                <i class="fa-solid fa-circle-play h-16 w-16 text-blue-700 bg-gray-50 rounded-full"></i>
               </div>
